...
class MyCurrencyField extends React.Component {
    constructor(props) {
        super(props)
...
//export default withStyles(styles)(MyCurrencyField);
export default styled(MyCurrencyField)(styles);
